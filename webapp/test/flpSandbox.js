		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Routing Split App Title",
									"targetURL": "#RoutingSplitAppTitle-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"RoutingSplitAppTitle-display": {
								"semanticObject": "RoutingSplitAppTitle",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=routingsplitapp",
									"url": sap.ui.require.toUrl("routingsplitapp")
								}
							}
						}
					}
